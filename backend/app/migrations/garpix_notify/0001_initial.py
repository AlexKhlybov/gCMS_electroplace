# Generated by Django 3.1 on 2021-07-29 21:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "telegram_chat_id",
                    models.CharField(
                        blank=True, default="", max_length=200, verbose_name="Telegram ID пользователя/чата"
                    ),
                ),
                (
                    "viber_chat_id",
                    models.CharField(blank=True, default="", max_length=200, verbose_name="Viber ID пользователя/чата"),
                ),
                (
                    "viber_secret_key",
                    models.CharField(blank=True, default="", max_length=200, verbose_name="Ключ подключения Viber"),
                ),
                ...
                (
                    "type",
                    models.IntegerField(
                        choices=[(0, "E-mail"), (1, "SMS"), (2, "Push"), (3, "Telegram"), (4, "Viber")],
                        verbose_name="Тип",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sms_url",
                    models.CharField(
                        default="http://sms.ru/sms/send", max_length=255, verbose_name="URL СМС провайдера"
                    ),
                ),
                (
                    "sms_api_id",
                    models.CharField(
                        blank=True, default="1234567890", max_length=255, verbose_name="API ID СМС провайдера"
                    ),
                ),
                (
                    "sms_from",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="000000000:AAAAAAAAAA-AAAAAAAA-_AAAAAAAAAAAAAA",
                        max_length=255,
                        verbose_name="Telegram API Key",
                    ),
                ),
                (
                    "viber_api_key",
                    models.CharField(
                        ...
                        default="000000000:AAAAAAAAAA-AAAAAAAA-_AAAAAAAAAAAAAA",
                        max_length=255,
                        verbose_name="Viber API Key",
                    ),
                ),
                (
                    "viber_bot_name",
                    models.CharField(
                        blank=True, default="Viber bot", max_length=255, verbose_name="Название viber бота"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        max_length=1000, upload_to=garpix_notify.utils.file.get_file_path, verbose_name="Файл"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_hour_used_times",
                    models.IntegerField(default=0, verbose_name="Количество использований в час"),
                ),
                (
                    "email_day_used_times",
                    models.IntegerField(default=0, verbose_name="Количество использований в день"),
                ),
                (
                    "email_hour_used_date",
                    models.DateTimeField(default=django.utils.timezone.now, verbose_name="Дата использований в час"),
                ),
                (
                    "email_day_used_date",
                    models.DateTimeField(default=django.utils.timezone.now, verbose_name="Дата использований в день"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")),
                (
                    "category",
